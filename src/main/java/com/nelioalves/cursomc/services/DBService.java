...
public class DBService {
	...
	public void instantieteTestDatabase() throws ParseException {		
		...
		Cliente cli1 = new Cliente(null,"Maria Silva","soparacadastro80@gmail.com","74788070030",TipoCliente.PESSOAFISICA, pe.encode("123"));
		Cliente cli2 = new Cliente(null,"Ana Costa","laurisimon@yahoo.com","65522263067",TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);
		
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));		
		cli2.getTelefones().addAll(Arrays.asList("99999999","123456789"));
